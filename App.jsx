...
const destinations = [
  {
    ...
    detail: "Documentamos y desarrollamos proyectos de investigación aplicada en inteligencia artificial, explorando su relación con las matemáticas y otras disciplinas. Publicamos avances, participamos en eventos académicos y construimos una base de conocimiento colectiva para el semillero.",
  ...
  },
  {
    ...
    detail: "Ofrecemos espacios de formación en fundamentos de inteligencia artificial, aprendizaje automático y herramientas de programación, dirigidos a los integrantes del semillero, para que cada semillerista adquiera las competencias necesarias para participar en los proyectos.",
  ...
  },
  {
    ...
    detail: "Trabajamos en la aplicación de algoritmos de IA a problemas reales, principalmente en el campo de las matemáticas y las ciencias, diseñando modelos y prototipos que muestran el potencial de estas herramientas en contextos prácticos.",
  ...
  },
  {
    ...
    detail: "Reunimos las iniciativas que nacen dentro del semillero: desde ideas exploratorias hasta prototipos funcionales. Cada proyecto pasa por etapas de planeación, desarrollo y evaluación, con el acompañamiento de docentes y estudiantes.",
  ...
  },
  {
    ...
    detail: "Compartimos los resultados de nuestro trabajo con la comunidad académica a través de ponencias, publicaciones y actividades de socialización, buscando generar impacto más allá del semillero.",
...
function App() {
  ...
  return (
    <>
        ...
        <div className="destination-grid container">
          {destinations.map((item) => (
            <article
              ...
              style={{backgroundImage: `linear-gradient(to top, rgba(5,8,10,.95), rgba(5,8,10,.08)), url(${item.image})`}}
            >
              <div>
                <h3>{item.title}</h3>
                <p>{item.text}</p>
      ...
      <div
        className={`card-modal-overlay${activeCard ? " is-open" : ""}`}
        onClick={(e) => { if (e.target === e.currentTarget) closeModal(); }}
      >
        {activeCard && (
          <div className="card-modal" role="dialog" aria-modal="true">
            <button className="card-modal-close" aria-label="Cerrar" onClick={closeModal}>✕</button>
